...
def load_pipeline():
    # Paths
    model_path = "result/model/assistV1.pth"
    scaler_x_path = "generate/dataset/numeric/lanjutan/scaler_x.pkl"
    scaler_y_path = "generate/dataset/numeric/lanjutan/scaler_y.pkl"
...
def ambil_data_by_waktu(waktu_target="hari_ini", data_dir="data/lanjutan"):
